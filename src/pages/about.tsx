export default function About() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center relative bg-gradient-to-br from-accent to-white">
      <section id="about" className="w-full max-w-4xl mx-auto px-6 lg:px-12 py-20">
        <div className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-2xl p-10 md:p-16 animate-fade-in">
          <h2 className="text-4xl md:text-5xl font-bold text-primary mb-6 text-center font-inter">Who We Are</h2>
          <p className="text-lg text-slate-700 mb-8 text-center font-satoshi">
          ...
          <p className="text-lg text-slate-700 mb-10 text-center font-satoshi">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            <div className="bg-white/80 rounded-xl p-6 shadow-md text-center">
              ...
              <p className="text-base text-slate-700 font-satoshi">
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center items-center mt-2">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-slate-700/90 text-sm font-satoshi">Premium solar panels and equipment from trusted manufacturers</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <span className="text-secondary mb-3">
                <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="font-semibold text-primary mb-1 font-inter">Industrial Lighting</h3>
              <p className="text-slate-700/90 text-sm font-satoshi">High-performance lighting systems for factories and public infrastructure</p>
            </div>
          </div>
        </div>
      </section>
